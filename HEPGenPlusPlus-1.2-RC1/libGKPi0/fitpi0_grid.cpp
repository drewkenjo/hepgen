...
gkSubProcessTableCache myCache[3];
...
int main (int argc, char** argv) {
  ...
  myCache[0].loadCache(hepPath+"/share/proton/pi0_cache/tableIndex");
  myCache[1].loadCache(hepPath+"/share/proton/eta_cache/tableIndex");
  myCache[2].loadCache(hepPath+"/share/neutron/pi0_cache/tableIndex");
