...
void HOutPutBackEndLEPTO::closeFile()
{
    outFile.flush();
    outFile.close();
}

HOutPutBackEndLEPTO::HOutPutBackEndLEPTO()
{
...
void HOutPutBackEndLEPTO::dumpEvent(HEvent* _event)
{
...
//     HLorentzVector sumKin;
//     cout << "IN!------" << endl;
//
//     for (int i=0; i < 2; i++)
//     {
//
//       eventPointer->getStruct()->listOfParticles.at(i)->printDebug();
//       sumKin = sumKin + eventPointer->getStruct()->listOfParticles.at(i)->getVector();
//
//     }
//    cout << "OUT!------" << endl;
//
//     for (int i = 3 ; i < eventPointer->getStruct()->listOfParticles.size(); i++)
//     {
//       if (eventPointer->getStruct()->listOfParticles.at(i)->getParticleAuxFlag() != 11)
//       {
//       eventPointer->getStruct()->listOfParticles.at(i)->printDebug();
//       sumKin = sumKin - eventPointer->getStruct()->listOfParticles.at(i)->getVector();
//       }
...
void HOutPutBackEndLEPTO::putFloat(float _f)
{
    outFile.write( (char*) &_f, floatSize);
}

void HOutPutBackEndLEPTO::putInt(int32_t _i)
{
    outFile.write( (char*) &_i, intSize);
}

void HOutPutBackEndLEPTO::putInt64(int64_t _i)
{
...
void HOutPutBackEndLEPTO::initFile(string _fileName, HEvent* _eventPointer)
{
...
void HOutPutBackEndLEPTO::setParams(HParamManager* _params)
{
    paramMan = _params;
}
...
void HOutPutBackEndLEPTO::writeHeader()
{
