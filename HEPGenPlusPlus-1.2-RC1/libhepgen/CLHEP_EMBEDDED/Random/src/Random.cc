...
#include "CLHEP_EMBEDDED/Utility/Utility/memory.h"

// -----------------------------
// Static members initialisation
// -----------------------------

#include "CLHEP_EMBEDDED/Random//Random/SeedTable.h"
...
std::string HepRandom::name() const {
    return "HepRandom";
}
...
std::ostream & HepRandom::put(std::ostream & os) const {
    return os;
}
std::istream & HepRandom::get(std::istream & is) {
    return is;
}
