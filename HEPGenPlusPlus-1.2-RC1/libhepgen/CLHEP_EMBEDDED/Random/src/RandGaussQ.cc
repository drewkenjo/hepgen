...
#include "CLHEP_EMBEDDED/Random/Random/RandGaussQ.h"
#include "CLHEP_EMBEDDED/Utility/Utility/PhysicalConstants.h"
#include <iostream>
#include <cmath>	// for std::log()

namespace CLHEP {

std::string RandGaussQ::name() const {
    return "RandGaussQ";
}
HepRandomEngine & RandGaussQ::engine() {
    return RandGauss::engine();
}
...
#include "CLHEP_EMBEDDED/Random/gaussQTables.cdat"
};
